...
public class ENSideMenu : NSObject, UIGestureRecognizerDelegate {
    ...
    var menuPosition:ENSideMenuPosition = .left
    ...
    var bouncingEnabled :Bool = false
    ...
    */
    internal init(sourceView: UIView, menuPosition: ENSideMenuPosition, blurStyle: UIBlurEffectStyle = .Light) {
        super.init()
    ...
    */
    internal convenience init(sourceView: UIView, menuViewController: UIViewController, menuPosition: ENSideMenuPosition, blurStyle: UIBlurEffectStyle = .Light) {
...
*/
    ...
    */
    ...
    func adjustFrameDimensions( width: CGFloat, height: CGFloat ) -> (CGFloat,CGFloat) {
    ...
    func toggleMenu (shouldOpen: Bool) {
        ...
        if (bouncingEnabled) {
            ...
            collisionBehavior.addBoundaryWithIdentifier("menuBoundaary", fromPoint: CGPoint(x: boundaryPointX, y: boundaryPointY), toPoint: CGPoint(x: boundaryPointX, y: height))
    ...
    internal func handlePan(recognizer : UIPanGestureRecognizer){
        ...
        case .Changed:
            ...
            recognizer.setTranslation(CGPoint.zero, inView: sourceView)
